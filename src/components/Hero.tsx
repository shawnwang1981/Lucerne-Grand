      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 md:gap-4 text-xs md:text-sm font-medium">
          <div className="flex items-center px-4 py-2 bg-white/80 backdrop-blur border border-[#1C1C1C]/10 rounded-full text-[#1C1C1C] shadow-sm">
            <span className="bg-[#8C7355] text-white px-2 py-0.5 rounded text-[10px] font-bold mr-2 uppercase tracking-widest">MRT</span>
            {projectData.mrt}
          </div>
          <div className="flex items-center px-4 py-2 bg-white/80 backdrop-blur border border-[#1C1C1C]/10 rounded-full text-[#1C1C1C] shadow-sm">
        ...
        <div className="pt-12">
          <p className="text-[10px] text-[#1C1C1C]/40 uppercase tracking-widest mb-2">Seeking Indication Of Interest</p>
          <p className="text-3xl md:text-4xl text-[#8C7355] font-serif uppercase">Coming Soon {projectData.launch}</p>
        </div>
      </motion.div>
    </section>
  );
