    ...
    <section className="py-24 bg-white text-[#1C1C1C] relative border-t border-[#1C1C1C]/10">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div>
              <h3 className="text-[#8C7355] uppercase tracking-[0.3em] text-[11px] font-bold mb-4">The Developer</h3>
              <h2 className="text-4xl md:text-5xl font-serif text-[#1C1C1C] leading-tight">
                City Developments <br />
                <span className="italic text-[#8C7355]">Limited (CDL)</span>
              </h2>
            </div>

            <p className="text-[#1C1C1C]/60 text-lg leading-relaxed">
              City Developments Limited (CDL) is a leading global real estate company with a network spanning 143 locations in 28 countries and regions. Listed on the Singapore Exchange, the Group is one of the largest companies by market capitalisation.
            </p>
            
            <p className="text-[#1C1C1C]/60 text-lg leading-relaxed">
              With a proven track record of over 60 years in real estate development, investment, and management, CDL has developed over 50,000 homes and owns around 23 million square feet of gross floor area in residential, commercial, and hospitality assets globally.
            </p>

            <div className="grid sm:grid-cols-2 gap-8 pt-8 border-t border-[#1C1C1C]/10">
              <div className="flex flex-col space-y-3">
                <Globe className="w-6 h-6 text-[#8C7355]" />
                <h4 className="text-lg font-medium text-[#1C1C1C]">Global Presence</h4>
                <p className="text-sm text-[#1C1C1C]/60">143 locations across 28 countries and regions.</p>
              </div>
              <div className="flex flex-col space-y-3">
                <Award className="w-6 h-6 text-[#8C7355]" />
                <h4 className="text-lg font-medium text-[#1C1C1C]">Trusted Legacy</h4>
                <p className="text-sm text-[#1C1C1C]/60">Over 60 years of proven track record and excellence.</p>
              </div>
            </div>
          </motion.div>
