  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white text-[#1C1C1C] relative border-t border-[#1C1C1C]/10">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div>
            <h3 className="text-[#8C7355] uppercase tracking-[0.3em] text-[11px] font-bold mb-4">Rare Proposition</h3>
            <h2 className="text-4xl md:text-5xl font-serif text-[#1C1C1C] leading-tight uppercase">
              A Rare Lakeside<br />Launch With<br />
              <span className="italic text-[#8C7355] capitalize">Convenience</span><br />
              <span className="italic text-[#8C7355] capitalize">Built In</span>
            </h2>
          </div>

          <p className="text-[#1C1C1C]/60 text-lg leading-relaxed max-w-lg">
            Lucerne Grand is expected to rise on a Lakeside Drive site zoned Residential with Commercial at Level 1 — a rare proposition in the precinct.
          </p>

          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              <Building2 className="w-6 h-6 text-[#8C7355]" />
              <span className="text-lg font-light tracking-wide">5 Blocks of 17 Storey</span>
            </div>
            <div className="flex items-center space-x-4">
              <TrendingUp className="w-6 h-6 text-[#8C7355]" />
              <span className="text-lg font-light tracking-wide">GFA Harmonised Development</span>
            </div>
          </div>
          
          <div className="pt-8 border-t border-[#1C1C1C]/10">
            <h4 className="text-[#8C7355] font-serif text-2xl mb-6">Why this matters</h4>
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="flex flex-col space-y-3">
                  ...
                  <p className="text-sm text-[#1C1C1C]/60">{text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-xl border border-[#1C1C1C]/10 relative">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <h3 className="text-2xl font-serif tracking-widest text-white uppercase">Lucerne</h3>
              <p className="tracking-[0.3em] text-white/80 uppercase text-sm">Galleria</p>
            </div>
          </div>
        </motion.div>
