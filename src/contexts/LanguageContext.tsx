...
const translations: Record<string, string> = {
  ...
  "Direct Contact": "直接联系",
  "Prefer to chat?": "希望直接对话？",
  "Message us on WhatsApp for an immediate response from our sales team.": "在 WhatsApp 上给我们留言，我们的销售团队将立即回复您。",
  "VIP Preview": "VIP 贵宾预览",
  "Register your interest": "注册您的意向",
  "Thank You": "谢谢您",
  "Your registration has been received. We will contact you shortly.": "您的注册已收到。我们将很快与您联系。",
  "Name": "姓名",
  "Phone": "电话",
  "Email": "电子邮箱",
  "Enquiries": "询问内容",
  "Select an option": "请选择",
  "interested in 2 bedder": "我对两居室感兴趣",
  "interested in 3 bedder": "我对三居室感兴趣",
  "interested in 4 bedder": "我对四居室感兴趣",
  "interested in floorplans": "我对平面图感兴趣",
  "interested in updated pricing": "我对最新价格感兴趣",
  "interested in ebook": "我对电子书感兴趣",
  "I am interested in a 3-bedroom unit...": "我对三居室单位感兴趣...",
  "Submitting...": "提交中...",
  "Submit Details": "提交详情",
